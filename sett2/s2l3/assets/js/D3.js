...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const ch = starWarsCharacters[i];

  switch (ch.eye_color) {
    case "blue":
      eyeColor.blue.push(ch);
      break;
    case "yellow":
      eyeColor.yellow.push(ch);
      break;
    case "brown":
      eyeColor.brown.push(ch);
      break;
    case "red":
      eyeColor.red.push(ch);
      break;
    case "blue-gray":
      eyeColor["blue-gray"].push(ch);
      break;
    default:
...
while(crew < starWarsCharacters.length){
  const ch = starWarsCharacters[crew];
  crewMass += ch.mass;
  crew++;
}
